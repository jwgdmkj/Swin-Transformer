...
_C.MODEL.SWIN.CHAN_HEADS = [1, 2, 4, 8]
...
_C.MODEL.SWINV2.CHAN_HEADS = [1, 2, 4, 8]
...
_C.MODEL.SWIN_MOE.CHAN_HEADS = [1, 2, 4, 8]
...
_C.MODEL.SWIN_MLP.CHAN_HEADS = [1, 2, 4, 8]
